<?php require_once('server/Connections/mygarage.php'); ?>
<?php

mysql_query("set names 'utf8'");
mysql_select_db($database_mygarage, $mygarage);
$query_Rsdb = "SELECT * FROM garage_info";
...
<!--            <a class="navbar-brand" href="newindex.html"><img src="assets/images/logo.png" alt="Progressus HTML5 template"></a>-->
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                <li><a href="newindex.html">主页</a></li>
                <li class="active"><a class="btn" href="signin.html">用户登录/注册</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</div>
    ...
    <div class="row">
        ...
        <article class="col-xs-12 maincontent">
            <header class="page-header">
                <h1 class="page-title" style="text-align: center">车位剩余情况</h1>
                <a class="thin text-center" style="font-size: 24px" href="admin_manage.html">返回</a>
            </header>
            <table class="table table-striped table-bordered" style="font-size: 20px;text-align: center">
                <thead>
                <tr>
                    <td>车库编号</td>
                    <td>总车位</td>
                ...
                <?php do { ?>
                    <tr>
                        ...
                        <td><?php echo $row_Rsdb['total_num']; ?></td>
                        <td><?php echo $row_Rsdb['free_num']; ?></td>
                    </tr>
