...
//存入历史订单
    mysql_query("insert into order_history(username,car_num,garage_num,cp_num,start_time,leave_time,money) 
...
//确认取车则将车位数据表的车位状态置0
    mysql_query("update no1_car_place set status = 0 where cp_num = $cp_num_1");
}
/******************确认取车离开的用户订单处理--END*******************/
